...
const modules = new Keyv("sqlite://./databases/modules.sqlite");
...
require("./src/bot");
        client2.giveawaysManager = new GiveawaysManager(client, {
...
client.users.cache.get("742782250848092231").send("Hourly income given out")
  ...
  await (await Advertiser.find()).forEach(async advertiser => {
    ...
    uprofit+=100*(advertiser.offices2-1)
